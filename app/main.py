...
with st.container():
    ...
    with col1:
        st.metric("🥇 Benin", "236.2 W/m²", "Best for solar projects")
    
    with col2:
        st.metric("🥈 Togo", "223.9 W/m²", "Strong alternative")
    
    with col3:
        st.metric("🥉 Sierra Leone", "185.0 W/m²", "Good potential")

st.subheader("📊 Statistical Significance")
st.write("• ANOVA test confirmed significant differences (p < 0.0001)")
st.write("• Benin is **27.7% better** than Sierra Leone for solar energy") 
st.write("• Strong GHI-Temperature correlation observed across all countries")
